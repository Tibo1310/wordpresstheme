...
function register_contenu_styles() {
    wp_enqueue_style('contenu-style', get_template_directory_uri() . '/contenu.css');
}
add_action('wp_enqueue_scripts', 'register_contenu_styles');
