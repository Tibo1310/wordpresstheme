...
<body>
    ...
    <div class="header-content">
        ...
        <div class="items"> <!-- Ajoutez une classe "items" ici -->
            <a href="<?php echo esc_url(home_url('/page-1')); ?>">Page 1</a>
            <a href="<?php echo esc_url(home_url('/page-2')); ?>">Page 2</a>
            <a href="<?php echo esc_url(home_url('/page-3')); ?>">Page 3</a>
            <a href="<?php echo esc_url(home_url('/page-4')); ?>">Page 4</a>
            <a href="<?php echo esc_url(home_url('/page-5')); ?>">Page 5</a>
            <a href="<?php echo esc_url(home_url('/page-6')); ?>">Page 6</a>
            <a href="<?php echo esc_url(home_url('/page-7')); ?>">Page 7</a>
            <a href="<?php echo esc_url(home_url('/page-8')); ?>">Page 8</a>
        </div>
    </div>
